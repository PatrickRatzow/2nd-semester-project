...
public class EmployeeDaoMsSql implements EmployeeDao {
    private static final String FIND_BY_ID_Q = "SELECT * FROM view_employee WHERE id = ?";
    private PreparedStatement findByIdPS;
    private static final String FIND_BY_ROLE_Q = "SELECT * FROM view_employee WHERE role_name = ?";
